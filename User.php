...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-orange sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- NAV ADMIN MENU -->
            <li class="nav-item">
                <a class="nav-link bg-dark" href="User.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php foreach($akun as $data): ?>
                          <tr>
                            ...
                            <td><?= $data["number"];?></td>
                            <td><?= $data["level"];?></td>
                            <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modaldelete">Delete</button></td>
                ...
                <div class="modal fade" id="modaldelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="deleteuser.php?id=<?php echo $data["id"] ?>">Delete</a>
                    </div>
                    </div>
                </div>
                </div>
